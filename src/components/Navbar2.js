...
function Navbar() {
  ...
  return (
    <div className="row m-0 p-2">
      <div className="header-div d-flex flex-row justify-content-between p-0 ">
        <div className="start-logo start-logo-flexs col  d-flex flex-row  justify-content-between">
          <div className="pt-1">
           <a href="app.js">
            {" "}
            <svg
